# Phenoscript Semantic Descriptions for Species of the Dung Beetle Genus _Grebennikovius_
...
- [Materializer](https://github.com/balhoff/materializer/releases/tag/v0.2.7)
    - Download and unpack the `tgz` file. Make the path, something like `.../bin/`, globally accessible for execution.
