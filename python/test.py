...
current_dir = '/Users/taravser/Library/CloudStorage/OneDrive-UniversityofHelsinki/My_papers/PhenoScript_main/Phenoscript-Descriptions/phenoscript_grebennikovius/toy_example/phenotypes'
# -----------------------------------------
# ARGUMENTS
# -----------------------------------------
...
uuid_n(6) 
    ...
    for otu in OTUs:
        ...
        traits_block.iri    = 'https://github.com/2323222344dsdyyy'
